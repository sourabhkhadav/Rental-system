...
import { Car, Plus, BarChart3, Shield, Clock, Users, Star, CheckCircle, ArrowRight, User, TrendingUp, Bell, DollarSign, Calendar } from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <Link 
                  to="/dashboard"
                  className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl font-semibold hover:shadow-lg transition-all transform hover:-translate-y-1"
                >
                ...
                <Link 
                  to="/add-car"
                  className="px-8 py-4 border-2 border-blue-600 text-blue-600 rounded-xl font-semibold hover:bg-blue-50 transition-colors text-center"
                >
                  Add New Car
                </Link>
              </div>
